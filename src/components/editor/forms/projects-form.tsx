...
export function ProjectsForm() {
    ...
    const addProject = () => {
        append({ id: crypto.randomUUID(), name: "", description: "", url: "" });
    };

    return (
        <div className="space-y-4">
             <Button onClick={addProject} className="w-full" variant="outline" type="button">
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-4 pt-2">
                                    <div className="space-y-2">
                                        ...
                                        <Input {...register(`projects.${index}.name`)} placeholder="Project X" />
                                    </div>
                                    <div className="space-y-2">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Textarea 
                                            ...
                                            placeholder="Description and technologies used..."
                                        />
                                    </div>
                                </CardContent>
                            </Card>
